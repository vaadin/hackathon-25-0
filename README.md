# Hackathon Rules
- Versions: Use Platform 25.0.0-beta9
...
- Communication: Use Slack channel #hackathon-25-0 for discussions.
- Documentation: Refer to https://vaadin.com/docs/v25/ for help and information.
